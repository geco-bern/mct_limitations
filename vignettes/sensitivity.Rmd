...
calc_cwd_lue0_byilon(5000, drop_data = FALSE, dirn = "data/df_cwd_lue0_2")
df <- readRDS("data/df_cwd_lue0_2/df_cwd_lue0_5000.rds")

## get data for one longitude slice, based on EF
calc_cwd_et0_byilon(5000, drop_data = FALSE, dirn = "data/df_cwd_et0_2/")
df <- readRDS("data/df_cwd_et0_2/df_cwd_et0_5000.rds")
```
