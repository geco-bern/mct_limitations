...
saveRDS(df_wwf, file = "data/df_wwf_rsip.rds")
```

```{r}
df_wwf <- readRDS("data/df_wwf_rsip.rds")
...
# col_obs <- "#0072B250"
#   
# col_mod_solid <- "#D55E00"
# col_obs_solid <- "#0072B2"

library(vhs)
cols <- vhs("maxell_gu")
col_mod <- add_alpha(cols[2], 0.6)
col_obs <- add_alpha(cols[3], 0.6)
  
col_mod_solid <- cols[2]
col_obs_solid <- cols[3]
...
gg <- df %>% 
  ...
  scale_fill_manual(values = c(col_mod, col_obs), labels = c(expression(italic(z)[CWDX80]), "Observed"), name = "") +
  scale_color_manual(values = c(col_mod_solid, col_obs_solid), guide = "none") +
  scale_discrete_manual("point_color", values = c(col_mod_solid, col_obs_solid), guide = "none") +
  coord_cartesian(clip = "off") +
  guides(fill = guide_legend(
    override.aes = list(
      fill = c(col_mod_solid, col_obs_solid),
...
gg_fig3a <- gg
saveRDS(gg_fig3a, file = "fig/gg_fig3a.rds")
...
gg_rsip_10
saveRDS(gg_rsip_10, file = "data/gg_rsip_10.rds")
...
gg_rsip_25 <- out$gg + labs(title = "25% quantile by biome, RSIP data",
              ...
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_25
saveRDS(gg_rsip_25, file = "data/gg_rsip_25.rds")
...
gg_rsip_50 <- out$gg + labs(title = "50% quantile by biome, RSIP data",
              ...
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_50
saveRDS(gg_rsip_50, file = "data/gg_rsip_50.rds")
...
gg_rsip_75 <- out$gg + labs(title = "75% quantile by biome, RSIP data",
              ...
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_75
saveRDS(gg_rsip_75, file = "data/gg_rsip_75.rds")
...
gg_rsip_90 <- out$gg + labs(title = "90% quantile by biome, RSIP data",
              ...
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_90
saveRDS(gg_rsip_90, file = "data/gg_rsip_90.rds")
```
...
gg_rsip_wtd_10 <- out$gg + labs(title = "10% quantile by biome, RSIP data, WTD subset",
              ...
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_wtd_10
saveRDS(gg_rsip_wtd_10, file = "data/gg_rsip_wtd_10.rds")
...
gg_rsip_wtd_25 <- out$gg + labs(title = "25% quantile by biome, RSIP data, WTD subset",
              ...
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_wtd_25
saveRDS(gg_rsip_wtd_25, file = "data/gg_rsip_wtd_25.rds")
...
gg_rsip_wtd_50 <- out$gg + labs(title = "50% quantile by biome, RSIP data, WTD subset",
              ...
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_wtd_50
saveRDS(gg_rsip_wtd_50, file = "data/gg_rsip_wtd_50.rds")
...
gg_rsip_wtd_75 <- out$gg + labs(title = "75% quantile by biome, RSIP data, WTD subset",
              ...
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_wtd_75
saveRDS(gg_rsip_wtd_75, file = "data/gg_rsip_wtd_75.rds")
...
gg_rsip_wtd_90 <- out$gg + labs(title = "90% quantile by biome, RSIP data, WTD subset",
              ...
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_wtd_90
saveRDS(gg_rsip_wtd_90, file = "data/gg_rsip_wtd_90.rds")
```
...
gg_fig3a <- gg
saveRDS(gg_fig3a, file = "data/gg_fig3a.rds")
gg
...
out <- df_biome_sites %>% 
  analyse_modobs2("q10_zroot_cwdx80", "q10_zroot_obs", 
                  shortsubtitle = TRUE, rsquared = FALSE)
gg_rsip_sites_10 <- out$gg + labs(title = "10% quantile",
              x = expression(italic(z)[CWDX80] ~ " (m)"),
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_sites_10
saveRDS(gg_rsip_sites_10, file = "data/gg_rsip_sites_10.rds")

out <- df_biome_sites %>% 
  analyse_modobs2("q25_zroot_cwdx80", "q25_zroot_obs", 
                  shortsubtitle = TRUE, rsquared = FALSE)
gg_rsip_sites_25 <- out$gg + labs(title = "25% quantile",
              x = expression(italic(z)[CWDX80] ~ " (m)"),
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_sites_25
saveRDS(gg_rsip_sites_25, file = "data/gg_rsip_sites_25.rds")

out <- df_biome_sites %>% 
  analyse_modobs2("q50_zroot_cwdx80", "q50_zroot_obs", 
                  shortsubtitle = TRUE, rsquared = FALSE)
gg_rsip_sites_50 <- out$gg + labs(title = "50% quantile",
              x = expression(italic(z)[CWDX80] ~ " (m)"),
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_sites_50
saveRDS(gg_rsip_sites_50, file = "data/gg_rsip_sites_50.rds")
ggsave("fig/modobs_zroot_q90_rsip_sites.pdf", width = 6, height = 5)

out <- df_biome_sites %>% 
  analyse_modobs2("q75_zroot_cwdx80", "q75_zroot_obs", 
                  shortsubtitle = TRUE, rsquared = FALSE)
gg_rsip_sites_75 <- out$gg + labs(title = "75% quantile",
              x = expression(italic(z)[CWDX80] ~ " (m)"),
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_sites_75
saveRDS(gg_rsip_sites_75, file = "data/gg_rsip_sites_75.rds")

out <- df_biome_sites %>% 
  analyse_modobs2("q90_zroot_cwdx80", "q90_zroot_obs", 
                  shortsubtitle = TRUE, rsquared = FALSE)
gg_rsip_sites_90 <- out$gg + labs(title = "90% quantile",
              x = expression(italic(z)[CWDX80] ~ " (m)"),
              y = expression("Observed" ~ italic(z)[r] ~ " (m)"))
gg_rsip_sites_90
saveRDS(gg_rsip_sites_90, file = "data/gg_rsip_sites_90.rds")
...
saveRDS(gg_rsip_sites_wtd_10, file = "data/gg_rsip_sites_wtd_10.rds")
...
saveRDS(gg_rsip_sites_wtd_25, file = "data/gg_rsip_sites_wtd_25.rds")
...
saveRDS(gg_rsip_sites_wtd_50, file = "data/gg_rsip_sites_wtd_50.rds")
...
saveRDS(gg_rsip_sites_wtd_75, file = "data/gg_rsip_sites_wtd_75.rds")
...
saveRDS(gg_rsip_sites_wtd_90, file = "data/gg_rsip_sites_wtd_90.rds")
```
