...
system("mkdir -p data/df_cwd_et0_3")
...
# df <- readRDS("data/df_cwdx/df_cwdx_ilon_5000.rds")
...
```{r}
df <- readRDS("data/df_cwdx_10_20_40.rds") # created by analysis/04_cwd_extremes/04_collect_return_levels.R
