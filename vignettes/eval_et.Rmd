...
obs_eval <- readRDS("data/obs_eval_v2.rds")
...
```{r}
obs_eval <- readRDS("data/obs_eval_v2_EVI.rds")
...
```{r  message=FALSE, warning=FALSE}
out_eval <- readRDS("data/out_eval_v2.rds")
...
mod <- readRDS("data/mod_v2_EVI.rds")
mod_evi <- mod
mod <- readRDS("data/mod_v2.rds")
