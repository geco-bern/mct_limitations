...
Submit the `prepare_rsip_forcing` UBELIX job to run `analysis/08_site_analysis/01_prepare_rsip_forcing.R`. This saves files in subdirectory `"./data/forcing_rsip/"`.

## Test

Submit one of the `rsofun_cwdx_*` UBELIX jobs to run `analysis/08_site_analysis/02_run_rsofun_cwdx.R` for different S_0 (WHC) values and diagnose them following the S_dEF method. This saves files in subdirectory `"./data/out_rsofun_cwdx/"`.
