...
filename <- if (run_model) {
  file.path(path, paste0("pmodel_output_", args[1], ".rds"))
} else {
  file.path(path, paste0("pmodel_drivers_", args[1], ".rds"))
}
if (file.exists(filename)) {
  message("File exists already: ", filename)
