...
df_rl_fet <- readRDS(climate_output_path("data/df_rl_fet.rds", config))  # loads df_rl_fet
...
saveRDS(df_rl_agg_fet, file = climate_output_path("data/df_rl_agg_fet.rds", config))
...
df_rl_agg_fet <- readRDS(climate_output_path("data/df_rl_agg_fet.rds", config))
...
saveRDS(gg_fig4a, file = climate_output_path("data/gg_fig5a.rds", config))
...
df_rl_nSIF <- readRDS(climate_output_path("data/df_rl_nSIF.rds", config))

# ## xxx debug
# df <- readRDS("data/df_rl/df_rl_fet_ichunk_TEST.rds")  # loads df
# df_rl_fet <- df
...
saveRDS(df_rl_agg_nSIF, file = climate_output_path("data/df_rl_agg_nSIF.rds", config))
...
df_rl_agg_nSIF <- readRDS(climate_output_path("data/df_rl_agg_nSIF.rds", config))
...
gg_fig4b <- gg$ggmap
saveRDS(gg_fig4b, file = climate_output_path("data/gg_fig5b.rds", config))
...
saveRDS(df_rl_agg, file = climate_output_path("data/df_rl_agg.rds", config))
...
saveRDS(df_rl_agg_test, file = climate_output_path("data/df_rl_agg_test.rds", config))

df_rl_agg_test <- readRDS(climate_output_path("data/df_rl_agg_test.rds", config))
